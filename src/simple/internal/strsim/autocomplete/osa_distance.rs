...
impl<K: Hash + Ord> SearchIndex<K> {
    ...
    /// using OSA (optimal string alignment) distance string similarity metric
    ...
    pub(crate) fn strsim_autocomplete_osa_distance(
        &self,
        user_keyword: &str,
    ) -> Vec<&str> {
        ...
        self.b_tree_map
            ...
            .for_each(|(index_keyword, index_keys)| {
                ...
                let score = osa_distance(index_keyword, user_keyword);
