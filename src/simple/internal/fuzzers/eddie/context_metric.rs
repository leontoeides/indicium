    ...
    where M: crate::simple::internal::fuzzers::eddie::Metric {
        ...
        self.b_tree_map
            ...
            .for_each(|(index_keyword, index_keys)| {
                ...
                let score = scorer.similarity(index_keyword, last_keyword);
