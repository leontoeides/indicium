...
/// This `Metric` trait implementation is used to access the
/// Jaro-Winkler algorithm, as implemented by Ilia Schelokov's
/// [eddie](https://crates.io/crates/eddie) crate, in a generic manner.
impl crate::simple::internal::fuzzers::eddie::Metric for eddie::str::JaroWinkler {
