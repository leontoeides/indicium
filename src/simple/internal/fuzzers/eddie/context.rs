...
impl<K: std::hash::Hash + Ord> crate::simple::search_index::SearchIndex<K> {
    ...
    ///   lowercase.
    ///
    /// * This method differs from `eddie_context_metric` in that this
        ...
        match self.index_range(last_keyword) {
            ...
            Some(index_range) => match self.eddie_metric.as_ref() {
                Some(EddieMetric::Levenshtein) => self
                    .eddie_context_metric::<Levenshtein>(
                        preceding_keywords,
                        preceding_results,
                        last_keyword,
                        &index_range,
                ...
                Some(EddieMetric::DamerauLevenshtein) => self
                    .eddie_context_metric::<DamerauLevenshtein>(
                        preceding_keywords,
                        preceding_results,
                        last_keyword,
                        &index_range,
                ...
                Some(EddieMetric::JaroWinkler) => self
                    .eddie_context_metric::<JaroWinkler>(
                        preceding_keywords,
                        preceding_results,
                        last_keyword,
                        &index_range,
