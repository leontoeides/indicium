...
impl<'s, K: Hash + Ord> crate::simple::internal::fuzzies::Fuzzy<'s, K> for Eddie {
    ...
    fn keyword_global(
        ...
        search_index.strsim_keyword_global(keyword)
    } // fn
    ...
    fn autocomplete_global(
        ...
        search_index.strsim_autocomplete_global(user_keyword)
    } // fn
    ...
    fn autocomplete_context(
        ...
        search_index.strsim_autocomplete_context(key_set, user_keyword)
    } // fn
} // trait Fuzzy