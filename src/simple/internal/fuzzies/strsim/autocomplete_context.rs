...
impl<K: Hash + Ord> crate::simple::search_index::SearchIndex<K> {
    ...
    ///
    /// * This method differs from `strsim_autocomplete_context_comparator`
    ...
    pub(crate) fn strsim_autocomplete_context(
        ...
        match strsim_metric {
            StrsimMetric::Jaro => self
                .strsim_autocomplete_context_comparator::<Jaro>(
                    &index_range,
                    key_set,
                    user_keyword
                ).collect(),
            ...
            StrsimMetric::JaroWinkler => self
                .strsim_autocomplete_context_comparator::<JaroWinkler>(
                    &index_range,
                    key_set,
                    user_keyword
                ).collect(),
            ...
            StrsimMetric::DamerauLevenshtein => self
                .strsim_autocomplete_context_comparator::<DamerauLevenshtein>(
                    &index_range,
                    key_set,
                    user_keyword
                ).collect(),
            ...
            StrsimMetric::Levenshtein => self
                .strsim_autocomplete_context_comparator::<Levenshtein>(
                    &index_range,
                    key_set,
                    user_keyword
                ).collect(),
            ...
            StrsimMetric::SorensenDice => self
                .strsim_autocomplete_context_comparator::<SorensenDice>(
                    &index_range,
                    key_set,
                    user_keyword
                ).collect(),
